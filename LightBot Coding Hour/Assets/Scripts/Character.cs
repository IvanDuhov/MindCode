...
public class Character : MonoBehaviour 
{
	...
	}  // Starts the coroutine - the execution of the commands
		...
		for (int i = 0; i < numOfOrders; i++) {
			...
			if (orders [i].sprite == Proc1Sprite) { // Procedure 1
				...
				for (int k = 0; k < numOfProcedure1Orders; k++) { 
					...
					if (procedure1Orders [k].sprite == Proc1Sprite) { // Colours the P1 in red
					...
					if (procedure1Orders [k].sprite == Proc2Sprite) { // GOTO procedure 2
						...
						for (int l = 0; l < numOfProcedure2Orders; l++) { 
							...
							if (procedure2Orders [l].sprite == Jump1) { // Jumping
								bool proceeded = false;
							...
							if (procedure2Orders [l].sprite == arrow) { // Going ahead
							...
							if (procedure2Orders [l].sprite == bulb) { // Enlightening the tile
							...
							if (procedure2Orders [l].sprite == leftSprite) { // Turning Left
							...
							if (procedure2Orders [l].sprite == rightSprite) { // Turning Right
							...
							if (procedure2Orders [l].sprite == Proc2Sprite) { // COlours Proc2 in red
								procedure2Orders [l].sprite = wrongP2;
								yield return new WaitForSeconds (0.6f);
								procedure2Orders [l].sprite = Proc2Sprite;
							}  // COlours Proc2 in red

							if (procedure2Orders [l].sprite == Proc1Sprite) { // COlours Proc1 in red
			...
			if (orders [i].sprite == Proc2Sprite) { // Procedure 2
				...
				for (int k = 0; k < numOfProcedure2Orders; k++) { 
					...
					if (procedure2Orders [k].sprite == Proc1Sprite) // Proc1
					{
						...
						if (procedure1Orders [p].sprite == Jump1) { // Jumping
							bool proceeded = false;
						...
						if (procedure1Orders [p].sprite == arrow) { // Going ahead
						...
						if (procedure1Orders [p].sprite == bulb) { // Enlightening the tile
						...
						if (procedure1Orders [p].sprite == leftSprite) { // Turning Left
						...
						if (procedure1Orders [p].sprite == rightSprite) { // Turning Right
						...
						if (procedure1Orders [p].sprite == Proc1Sprite) { // PROC1 - Colours it in red as it isnt possible
								procedure1Orders [p].sprite = wrongP1;
								yield return new WaitForSeconds (0.6f);
								procedure1Orders [p].sprite = Proc1Sprite;
							}  // PROC1 - Colours it in red as it isnt possible

						if (procedure1Orders [p].sprite == Proc2Sprite) { // PROC2 - Colours it in red as it isnt possible
